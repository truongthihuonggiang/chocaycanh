...
class TruyxuatScreen extends StatelessWidget {
  final String madinhdanh;
  static String routeName = "/truyxuat";
  const TruyxuatScreen({Key key, @required this.madinhdanh}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Body(madinhdanh: madinhdanh),
    );
  }
